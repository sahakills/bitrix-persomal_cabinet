                ...
                <div class="form-info-registration">
                    <div class="form__clone-container">
                        <div class="form-row">
                            ...
                            <input required data-error-target="element-TITLE" type="text" name="TITLE" placeholder="Заголовок новости*" value="<?=$arResult["FIELDS"]["NAME"]?>">
                            <span class="error-input-message" id="element-TITLE">Необходимо ввести заголовок</span>
                        </div>
                        <div class="form-row">
                            <label class="item-label">Дата и время события*</label>
                            <input required data-error-target="element-event-time" type="text" name="event-time" placeholder="Время события*" value="<?=$arResult["PROPERTY"]["EVENTS_TIME"]["VALUE"]?>">
                            <span class="error-input-message" id="element-event-time">Необходимо ввести время события</span>
                        </div>
                        <div class="form-row">
                            <label class="item-label">Место проведения события*</label>
                            <input required data-error="element-event-place" type="text" name="event-place" placeholder="Место проведения события*" value="<?=$arResult["PROPERTY"]["EVENTS_PLACE"]["VALUE"]?>">
                            <span class="error-input-message" id="element-event-date">Необходимо добавить место проведения</span>
                        </div>
                        <label class="item-label">Текст события*</label>
                        <div class="form-row">
                            <?php
                            $APPLICATION->IncludeComponent(
                                "mendeleev:tinymce",
                                ...
                                array(
                                    ...
                                    "TEXTAREA_PLACEHOLDER" => "Текст новости*",
                                    "REQUIRED" => 'Y',
                        ...
                        <div class="form-row">
                            ...
                            <div class="news-add-photo">
                                <div class="photo-element">
                                    ...
                                    <input id="file-input" type="file" value=""  name="detail-picture">
                                    <? if (!empty($arResult["FIELDS"]["PREVIEW_PICTURE"])): ?>
                    ...
                    <div class="append-form__container"></div>
                        <div class="profile-view-wrap-footer">
                            ...
                            <a href="<?=$arResult["LINK_BACK"]?>" class="btn-text">Отменить</a>
                        </div>
                    </div>
                </div>
            </div>
