                ...
                <div class="form-info-registration">
                    <div class="form__clone-container">
                        <div class="form-row">
                            ...
                            <input required data-error-target="element-TITL" type="text" name="TITLE" placeholder="Заголовок новости*" value="<?=$arResult["FIELDS"]["NAME"]?>">
                            <span class="error-input-message" id="element-TITLE">Необходимо ввести заголовок</span>
                        </div>
                        <div class="form-row">
                            <label class="item-label">Дата публикации*</label>
                            <input required data-error-target="element-date-active"  type="date" name="date-active" placeholder="Дата публикации*" value="<?=date("Y-m-d", strtotime($arResult["FIELDS"]["ACTIVE_FROM"]))?>">
                            <span class="error-input-message" id="element-date-active">Необходимо ввести дату публикации</span>
                        </div>

                        <label class="item-label">Текст новости*</label>
                        <div class="form-row">
                            <?php
                            $APPLICATION->IncludeComponent(
                                "mendeleev:tinymce",
                        ...
                        <div class="form-row">
                            <label class="item-label">Источник новости</label>
                            <input type="text" name="sourse" placeholder="Источник новости" value="<?=$arResult["PROPERTY"]["SOURSE"]["VALUE"]?>">
                        </div>
                        <div class="form-row">
