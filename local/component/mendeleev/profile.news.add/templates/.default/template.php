...
<div class="news-wrapper">
    ...
    <div class="row profile-view-wrap services news-add-element">
                <div class="services-box">
                    <div class="header-h3">Добавление новости</div>
                    <?
                    if ($arResult["ERROR"]) :
                    ?>
                            ...
                            <div class="form-info-registration">
                                <div class="form__clone-container">
                                    <div class="form-row">
                                        ...
                                        <input data-error-target="element-TITLE" required type="text" name="element[TITLE][]" placeholder="Заголовок новости*">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <input data-error-target="element-date-active" required data-error="" type="date" name="element[date-active][]" placeholder="Дата публикации*">
                                        <span class="error-input-message" id="element-date-active">Необходимо выбрать дату публицации</span>
                                    </div>
                                    <div class="form-row">
                                        ...
                                        $APPLICATION->IncludeComponent(
                                            ...
                                            array(
                                                ...
                                                "REQUIRED" => 'Y',
                                                "MSG_ERROR" => "Необходимо указать Текст новости"
                                            ),
                                            false
                                        );
                                        ?>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <input type="text" name="element[sourse][]" placeholder="Источник новости">
                                    </div>
